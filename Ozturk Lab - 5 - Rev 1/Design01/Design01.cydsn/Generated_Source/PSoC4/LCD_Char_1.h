...
#define LCD_Char_1_PORT_MASK                ((uint32) (LCD_Char_1_LCDPort__MASK))
...
/* Pin Masks */
#define LCD_Char_1_RS                     ((uint32) \
                                                (((uint32) 0x20u) << LCD_Char_1_LCDPort__SHIFT))
#define LCD_Char_1_RW                     ((uint32) \
                                                (((uint32) 0x40u) << LCD_Char_1_LCDPort__SHIFT))
#define LCD_Char_1_E                      ((uint32) \
                                                (((uint32) 0x10u) << LCD_Char_1_LCDPort__SHIFT))
#define LCD_Char_1_READY_BIT              ((uint32) \
                                                (((uint32) 0x08u) << LCD_Char_1_LCDPort__SHIFT))
#define LCD_Char_1_DATA_MASK              ((uint32) \
                                                (((uint32) 0x0Fu) << LCD_Char_1_LCDPort__SHIFT))
