...
// DieTemp_P4_v1_0(CY_COMPONENT_NAME=DieTemp_P4_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DieTemp, CY_INSTANCE_SHORT_NAME=DieTemp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1 SP2, INSTANCE_NAME=DieTemp, )
...
module top ;
	...
	wire [0:0] tmpOE__Wg1_net;
	wire [0:0] tmpFB_0__Wg1_net;
	wire [0:0] tmpIO_0__Wg1_net;
	wire [0:0] tmpINTERRUPT_0__Wg1_net;
	electrical [0:0] tmpSIOVREF__Wg1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Wg1
		 (.oe(tmpOE__Wg1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Wg1_net[0:0]}),
		  .io({tmpIO_0__Wg1_net[0:0]}),
		  .siovref(tmpSIOVREF__Wg1_net),
		  .interrupt({tmpINTERRUPT_0__Wg1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Wg1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Ozturk_net;
	wire [0:0] tmpFB_0__Ozturk_net;
	wire [0:0] tmpIO_0__Ozturk_net;
	wire [0:0] tmpINTERRUPT_0__Ozturk_net;
	electrical [0:0] tmpSIOVREF__Ozturk_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Ozturk
		 (.oe(tmpOE__Ozturk_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ozturk_net[0:0]}),
		  .analog({Net_132}),
		  .io({tmpIO_0__Ozturk_net[0:0]}),
		  .siovref(tmpSIOVREF__Ozturk_net),
		  .interrupt({tmpINTERRUPT_0__Ozturk_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ozturk_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
